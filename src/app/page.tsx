...
function DesignView({ ai, setAi, prompt, setPrompt }: { ai: boolean; setAi: (v: boolean) => void; prompt: string; setPrompt: (v: string) => void }) {
  return (
    <div className="content">
      <Header eyebrow="Canvas" title="Design" description="A real document canvas. Edit it yourself, or let the agent operate the same tools." />
      <DesignEditor ai={ai} setAi={setAi} prompt={prompt} setPrompt={setPrompt} />
    </div>
  );
}
